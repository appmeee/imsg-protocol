...
@Test func listChatsReturnsChat() throws {
...
@Test func chatInfoReturnsMetadata() throws {
    let store = try TestDatabase.makeStore()
...
@Test func participantsReturnsUniqueHandles() throws {
    let db = try Connection(.inMemory)
    try db.execute(
        """
        CREATE TABLE chat (
...
@Test func messagesByChatReturnsMessages() throws {
    let store = try TestDatabase.makeStore()
...
@Test func messagesByChatAppliesDateFilterBeforeLimit() throws {
    let store = try TestDatabase.makeStore()
...
@Test func messagesByChatAppliesParticipantFilterBeforeLimit() throws {
    let store = try TestDatabase.makeStore()
...
@Test func messagesAfterReturnsMessages() throws {
    let store = try TestDatabase.makeStore()
...
@Test func messagesAfterExcludesReactionRows() throws {
...
@Test func messagesExcludeReactionRows() throws {
    let db = try makeInMemoryMessageDB()
...
@Test func messagesExposeReplyToGuid() throws {
    let db = try makeInMemoryMessageDB()
...
@Test func messagesReplyToGuidHandlesNoPrefix() throws {
    let db = try makeInMemoryMessageDB()
...
@Test func messagesExposeThreadOriginatorGuidWhenAvailable() throws {
...
@Test func attachmentsByMessageReturnsMetadata() throws {
    let store = try TestDatabase.makeStore()
...
@Test func longRepeatedPatternMessage() throws {
    let db = try Connection(.inMemory)
    try db.execute(
        """
        CREATE TABLE message (
